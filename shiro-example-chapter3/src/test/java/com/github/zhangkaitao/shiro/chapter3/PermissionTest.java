...
public class PermissionTest extends BaseTest {
	...
	public void testIsPermitted() {
		...
		// "user:delete"));
		// 判断没有权限：user:view
		//Assert.assertFalse(subject().isPermitted("user:view:qwe"));

		Assert.assertTrue(subject().isPermittedAll("system:vIew:qWE"));
		
		System.out.println(((DelegatingSubject)subject()).getSecurityManager().getClass());
	}
	...
	public void testWildcardPermission1() {
		login("classpath:shiro-permission.ini", "li2", "123");
